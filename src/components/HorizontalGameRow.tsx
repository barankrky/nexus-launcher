...
export default function HorizontalGameRow({ title, games, autoPlay = true, interval = 4000 }: HorizontalGameRowProps) {
  ...
  }, [autoPlay, interval, isUserInteracting, scrollPosition]);
  ...
  return (
    <section className="mb-8">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-pure-white text-xl font-semibold font-inter">{title}</h3>
